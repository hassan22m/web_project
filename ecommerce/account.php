...
if(isset($_POST['change_password'])){
  ...
  //if password less than 8 chars 
    ...
    if($stmt->execute()){
      ...
      header("location:account.php?error=couldn't change password");
    }
  }
}
...
if(isset($_SESSION['logged_in'])){
  ...
  $stmt->execute(); 
  $orders = $stmt->get_result(); // this should return an array
...
?>
            ...
            <div class="col-lg-6 col-md-12 col-sm-12">
                <form method = "POST" action="account.php" id="account-form">
                    ...
                    <div class="form-group">
                        ...
                        id="account-password" placeholder="Passowrd"
                        name="password" required>
                    </div>
                    <div class="form-group">
                        <label for="">Confirm Password</label>
                        <input type="password" class="form-control"
                        id="account-password-confirm" placeholder="Confirm Passowrd"
      ...
      <section  id="orders"class="orders container mt-5 py-1">
              ...
              <tr>
                <td>
                    <!-- <div class="product-info">
                          <img src="assets/images/headset3.png">  
                        <div>
