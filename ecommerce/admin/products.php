        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
          ...
          <div>
            ...
            <?php if(isset($_GET['deleted_fail'])){?>
                <p class="text-center" style="color:red;"><?php echo $_GET['deleted_fail'];?></p>
            <?php } ?>
              ...
              <table class="table table-striped table-sm">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a class="btn btn-success" href="<?php echo "edit_images.php?product_id=". $product['product_id']."&product_name=".$product['product_name'];?>">Edit images</a></td>
